...
function buildDatas(result) {
    ...
    for ( var prop in result) {
        ...
        html += " <tr id='tr_"+prop+"'>" +
            ...
            "<td><div class=\"text-center\"><button type=\"button\" class=\"btn btn-info\" style=\"font-size: 5px\"  onclick='edit("+prop+")'>編輯</button>&nbsp;" +
            "<button type=\"button\" class=\"btn btn-danger\" style=\"font-size: 5px\">刪除</button>  </div></td>"+
            "</tr>"
    }
